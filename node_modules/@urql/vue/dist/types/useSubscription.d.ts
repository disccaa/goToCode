...
export declare function callUseSubscription<T = any, R = T, V = object>(_args: UseSubscriptionArgs<T, V>, handler?: SubscriptionHandlerArg<T, R>, client?: Ref<Client>, stops?: WatchStopHandle[]): UseSubscriptionResponse<T, R, V>;
export {};
