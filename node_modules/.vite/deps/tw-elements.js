...
var require_index_min = __commonJS({
  "node_modules/tw-elements/dist/js/index.min.js"() {
    !function(n) {
      ...
      } }, d = wt, Ot = (t(176), t(177), /* @__PURE__ */ new Map()), kt = function(t2, e2, n2) {
        Ot.has(t2) || Ot.set(t2, /* @__PURE__ */ new Map());
        t2 = Ot.get(t2);
      ...
      var Ye = { name: "flip", enabled: true, phase: "main", fn: function(t2) {
        ...
        if (!f2.modifiersData[t2]._skip) {
          ...
          }, []), s2 = f2.rects.reference, u2 = f2.rects.popper, l2 = /* @__PURE__ */ new Map(), m2 = true, g2 = c2[0], b2 = 0; b2 < c2.length; b2++) {
      ...
      function Ge(t2) {
        var n2 = /* @__PURE__ */ new Map(), r2 = /* @__PURE__ */ new Set(), o2 = [];
...
// dep:tw-elements
var tw_elements_default = require_index_min();
export {
  tw_elements_default as default
};
